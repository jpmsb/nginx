...
RUN apt update && \
    ...
    echo '' >> /etc/nginx/nginx.conf && \
    echo "    log_format bonito 'Endereço IP: \$remote_addr\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Data: \$time_local\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Requisição: \$request\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Status: \$status\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Bytes enviados: \$body_bytes_sent\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Agente: \$http_user_agent\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Origem da requisição: \$http_referer\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Usuário: \$remote_user\n'" >> /etc/nginx/nginx.conf && \
    echo "                      'Redirecionado de: \$http_x_forwarded_for\n'" >> /etc/nginx/nginx.conf && \
    echo "                      '------------------------------------------';" >> /etc/nginx/nginx.conf && \
    echo '' >> /etc/nginx/nginx.conf && \
